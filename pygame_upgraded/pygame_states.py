...
class BattleScreen:
    ...
    def render(self, screen):
        ...
        quiz_button()
        textbox_gunnar = TextBox((0.5, 0.2), "fonts//RobotoSlab-Medium.ttf", 30, False, WHITE, "It's your turn!")
...
class AttackScreen:
    ...
    def render(self, screen):
        ...
        textbox_gunnar = TextBox((0.5, 0.2), "fonts//RobotoSlab-Medium.ttf", 25, False, YELLOW, self.text_gunnar)
        textbox_gunnar.render(screen)

        textbox_ada = TextBox((0.5, 0.2), "fonts//RobotoSlab-Medium.ttf", 25, False, RED, self.text_ada)
...
class WinnerScreenAda:
    ...
    def render(self, screen):
        ...
        screen.blit(logo, (215, -55))
        text_speech(screen, "fonts//RobotoSlab-Medium.ttf", 30, "Better luck next time,", YELLOW_LIGHT, 386, 150, True)
        text_speech(screen, "fonts//RobotoSlab-Medium.ttf", 30, f"{ada.name} won!", YELLOW_LIGHT, 385, 200, True)
        quit_button()
...
def glada_gunnar(x, y, a, b):
        ...
        text_speech(screen, "fonts//RobotoSlab-Medium.ttf", 15, f"{gunnar.name}", gunnar.color, a, b, True)
        text_speech(screen, "fonts//RobotoSlab-Medium.ttf", 15,
...
def aggressive_ada(x, y, a, b):
    ...
    text_speech(screen, "fonts//RobotoSlab-Medium.ttf", 15, f"{ada.name}", ada.color, a, b, True)
    text_speech(screen, "fonts//RobotoSlab-Medium.ttf", 15, f"Stats: HP: {ada.health} Attack: {ada.attack} Mood: {ada.mood}",
                WHITE, 630, 575, True)
...
def attack_button():
    ...
    if 87 <= mouse[0] <= 87 + 150 and 430 <= mouse[1] <= 430 + 50:
        ...
        text_speech(screen, "fonts//RobotoSlab-Black.ttf", 25, "Attack", BLACK, 162, 453, True)
...
def special_attack_button():
    ...
    if 325 <= mouse[0] <= 325 + 150 and 430 <= mouse[1] <= 430 + 50:
        ...
        text_speech(screen, "fonts//RobotoSlab-Black.ttf", 25, "Special", BLACK, 400, 453, True)
...
def quiz_button():
    ...
    if 563 <= mouse[0] <= 563 + 150 and 430 <= mouse[1] <= 430 + 50:
        ...
        text_speech(screen, "fonts//RobotoSlab-Black.ttf", 25, "Quiz", BLACK, 638, 453, True)
